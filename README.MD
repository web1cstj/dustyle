...
- Récupérer le dossier compressé <a href="https://github.com/web1cstj/dustyle/archive/refs/heads/depart.zip">dustyle.zip</a> et le décompresser.
- Ouvrir le dossier `dustyle` dans `VSCode`.
